class BancoDeDados {
  constructor() {
    ...
    this.alunos = [{id: 2212,name: 'Paulo', idade: 18, email: 'paulo@gmail.com', password: '1111', idSala: 2}, {id: 1211,name: 'Henrique', idade: 16, email: 'henrique@gmail.com', password: '2222', idSala: 2}];
