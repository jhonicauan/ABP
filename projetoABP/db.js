class BancoDeDados {
  constructor() {
    ...
    this.alunos = [{id: 1,nome: 'Paulo', idade: 18, email: 'paulo@gmail.com', senha: '1111', idSala: 1}, {id: 2,nome: 'Henrique', idade: 16, email: 'henrique@gmail.com', senha: '2222', idSala: 2}];
    ...
    this.atividades = [{id: 1, idAluno: 2, idMateria: 2,idProfessor:1, titulo: 'ATV 01 avaliativa', descricao: 'bla bla bla bla', nota: 8.8}];
  }
}
